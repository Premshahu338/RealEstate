...
$(document).ready(function () {
    ...
    $(".customizer-color.dark li").on('click', function() {
        ...
        $(this).addClass("active");
        $("body").attr("class", "dark-only");
        sessionStorage.setItem("dark", "dark-only");
    });


    if(sessionStorage.getItem("primary") != null) {
        document.documentElement.style.setProperty('--theme-deafult', sessionStorage.getItem("primary"));
    }
    if(sessionStorage.getItem("secondary") != null) {
        document.documentElement.style.setProperty('--theme-secondary', sessionStorage.getItem("secondary"));
    }
    ...
    $('.sidebar-type li').on('click', function () {
        ...
        switch (type) {
            case 'defaul-layout': {
                ...
                $(this).addClass("active");
                sessionStorage.setItem('page-wrapper', 'compact-wrapper');
                break;
            }
            case 'modern-layout': {
                $(".page-wrapper").attr("class", "page-wrapper compact-wrapper modern-sidebar" + boxed);
                sessionStorage.setItem('page-wrapper', 'compact-wrapper modern-sidebar');
                break;
            }
            case 'compact-layout': {
                $(".page-wrapper").attr("class", "page-wrapper compact-sidebar" + boxed);
                sessionStorage.setItem('page-wrapper', 'compact-wrapper compact-sidebar');
                break;
            }
            case 'normal-sidebar': {
                $(".page-wrapper").attr("class", "page-wrapper horizontal-wrapper " + boxed);
                $(".logo-wrapper").find('img').attr('src', '../assets/images/logo/logo.png');
                sessionStorage.setItem('page-wrapper', 'horizontal-wrapper');
                sessionStorage.setItem('page-body-wrapper', 'horizontal-menu');
                break;
            }
