...
$('.demo-imgs .hover-link .html').on('click', function () {
    ...
    switch (type) {
        case 'default-body':
        {
            ...
            sessionStorage.setItem('page-wrapper', 'only-body');
            break;
        }
        ...
        case 'dark-sidebar':
        {
            ...
            sessionStorage.setItem('page-wrapper', 'compact-wrapper dark-sidebar');
            break;
        }
        ...
        case 'compact-wrap':
        {
            ...
            sessionStorage.setItem('page-wrapper', 'compact-sidebar');
            break;
        }
        ...
        case 'color-sidebar':
        {
            ...
            sessionStorage.setItem('page-wrapper', 'compact-wrapper color-sidebar');
            break;
        }
        ...
        case 'compact-small':
        {
            ...
            sessionStorage.setItem('page-wrapper', 'compact-sidebar compact-small');
            break;
        }
        ...
        case 'box-layout':
        {
            ...
            sessionStorage.setItem('page-wrapper', 'compact-wrapper box-layout');
            break;
        }
        ...
        case 'enterprice-type':
        {
            ...
            sessionStorage.setItem('page-wrapper', 'horizontal-wrapper enterprice-type');
            break;
        }
        ...
        case 'modern-layout':
        {
            ...
            sessionStorage.setItem('page-wrapper', 'compact-wrapper modern-type');
            break;
        }
        ...
        case 'material-layout':
        {
            ...
            sessionStorage.setItem('page-wrapper', 'horizontal-wrapper material-type');
            } else {
            $(".page-wrapper").attr("class", "page-wrapper compact-wrapper material-type" + boxed);
            sessionStorage.setItem('page-wrapper', 'compact-wrapper material-type');
            }
        ...
        case 'advance-type':
        {
            ...
            sessionStorage.setItem('page-wrapper', 'horizontal-wrapper enterprice-type advance-layout');
            break;
        }
        ...
        case 'material-icon':
        {
            ...
            sessionStorage.setItem('page-wrapper', 'compact-sidebar compact-small material-icon');
            break;
        }
