    ...
    $(".page-wrapper").attr("class", "page-wrapper "+sessionStorage.getItem("page-wrapper"));
    $(".page-body-wrapper").attr("class", "page-body-wrapper "+sessionStorage.getItem("page-body-wrapper"));

    if (sessionStorage.getItem("page-wrapper") === null) {
